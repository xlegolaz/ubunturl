...
myFont :: String
myFont = "xft:UbuntuMono Nerd Font Mono:regular:size=9:antialias=true:hinting=true"
...
myChat :: String
myChat = "telegram-desktop"    -- Telegram / Chat Application

myTerminal :: String
myTerminal = "alacritty"    -- Sets default terminal

myScreenShot :: String
myScreenShot = "flameshot"      -- Screenshot app / Flameshot

myWallpaper :: String
myWallpaper = "nitrogen"        -- Wallpaper

myFileman :: String
myFileman = "nautilus"            -- File Manager
...
myWorkspaces = [" dev ", " www ", " chat ", " term ", " mus ", " sys ", " test ", " vid ", " edi "]
...
--        , ("M-p t", spawn "dm-translate")     -- translate text (Google Translate)
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        ...
        , ("M-g", spawn (myChat))        --Launch Telegram
        , ("M-w", spawn (myWayEmacs))    -- My way to open Emacs gui
        , ("M-S-v", spawn (myScreenShot))  --Launch Flameshot
        --, ("M-v", spawn (myMusica))        -- Launch nuclear
        , ("M-S-b", spawn (myWallpaper))    -- Launch Nitrogen
        , ("M-S-g", spawn (myFileman))        -- Launch PCmanFm
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
             ...
             -- , ppTitle = xmobarColor color16 "" . shorten 60      --Set Window Title Color
              , ppTitle = const ""                                   -- Remove Window Title
                -- Separator character
